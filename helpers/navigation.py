...
def make_sidebar():
    with st.sidebar:
        ...
        st.markdown("<h1 style='text-align: center; color: grey;'>Gestión de Casas de Bendición</h1>", 
...
def _extracted_from_make_sidebar():
    ...
    if ur.ClsUsuariosRoles.roles()['SOBRES-DISCIPULADOS'] == 1:
        st.page_link("pages/page4.py", label="Discipulados - registro de sobre", icon=None)
